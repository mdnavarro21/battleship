...
describe("placeShip function", () => {
  ...
  const mockShip1_placed = {
    ship: mockShip1,
    start_coordinates: [2, 0],
    direction: "horizontal",
  };
  const mockShip2_placed = {
    ship: mockShip2,
    start_coordinates: [0, 2],
    direction: "vertical",
  };
  const mockShip3_placed = {
    ship: mockShip3,
    start_coordinates: [2, 5],
    direction: "vertical",
  };
  ...
  test("Happy Path 2: vertical placement", () => {
    ...
    expect(gameBoard.getPlacedShips()).toEqual([
      mockShip1_placed,
      mockShip2_placed,
    ]);
  ...
  test("Invalid coordinates - another ship is in the way!", () => {
    ...
    expect(gameBoard.getBoard()[5]).toEqual([
      null,
      null,
      "Battleship",
      null,
